  ...
  return (
    <main className="min-h-screen bg-black text-bone relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(transparent 92%, rgba(244,244,240,0.06) 100%), linear-gradient(90deg, transparent 92%, rgba(244,244,240,0.06) 100%)',
      ...
      <section className="px-6 md:px-12 lg:px-24 pt-16 pb-16 relative">
        ...
        >
          ...
          <p className="font-grotesk text-lg md:text-xl text-bone/60 mt-6 max-w-3xl">
            A cohesive interface lattice for high-trust environments. Quiet, precise,
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            ...
            <p className="font-grotesk text-bone/60 leading-relaxed">
              Pearl prioritizes clarity and trust over spectacle. It establishes a
              calm contract with users, making complex workflows feel ceremonial.
            </p>
            <ul className="space-y-2 text-sm text-bone/50 font-grotesk">
              <li>Monochrome hierarchy with micro-contrast.</li>
              <li>Token-driven spacing and consistent rhythm.</li>
              <li>Accessibility embedded, not layered on.</li>
            </ul>
          </div>
          <div className="border border-bone/10 bg-ink/40">
            <img
              src="/case-studies/pearl/pearl-ui.jpg"
              alt="Pearl full UI"
